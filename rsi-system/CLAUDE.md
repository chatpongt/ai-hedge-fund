...
ทำงานบน Mac Mini M4 Pro 48GB ใช้ Local AI (MLX) เป็น brain หลัก, Cloud AI เสริมข้อมูลเท่านั้น
...
| Model           | Size   | Purpose                                |
|-----------------|--------|----------------------------------------|
| Qwen 3 32B Q4  | ~20GB  | Main: analysis, wiki, report           |
| Qwen 3 4B Q4   | ~3GB   | Fast: parse, triage, routing           |
| DeepSeek-R1 32B| ~20GB  | Deep reasoning: nash, mta, valuation   |
